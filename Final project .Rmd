...
*Outcomes*: Emotional well-being, or depression risk using the PHQ depression scale (derived with two variables, hc[round#]depresan1 and hc[round#]depresan2 that are summed)

*Tentative predictors and covariates*: Social network size, physical health score (derived from summed cardio exercise and walk variables), cognitive assessment (memory, at risk for dementia), assistance with ADLs like groceries and banking, demographic variables (age, race, education) - initial values for these in round 1 and 5.  
