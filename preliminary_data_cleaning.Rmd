...
Plotting of participant view of living situation predictor against PHQ-2, stratified by race (EM)
...
logit_model = nhats %>%
  ...
  glm(phq_cat ~ gender + age_cat + race_ethnicity + cane_walker_wheelchair + memory + overall_health + likes_living_situation + sn5dnumsn, family = "binomial", data = .) 
