...
Attempting plotting of predictors-- this code doesn't work, but basically hoping to plot n of phq values rather than sum and the different snsize categories
...
Plotting social network by phq_cat:
